...
document.getElementById('mensajesEsta').addEventListener('change', function (event) {
    ...
    var solicitarRespuesta="Estimado cliente\n\nNos dirigimos a usted en relación a la propuesta brindada para la solución de su deuda pendiente con el *Banco BBVA*.Es importante que se comunique con nosotros de inmediato para confirmar su aceptación.\n\nSu pronta respuesta es necesaria para dar solución a la deuda y evitar perder el beneficio.\n\nAtte:*Área Cobranzas*"
    ...
    if (mensajesEstand == "rv") {
        ...
        mensaje=formasPagos;
        mostrarMsgAdicionales.innerHTML=formasPagos;
    }
    else {
        mensaje = "";
